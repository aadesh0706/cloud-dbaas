        ...
        <div className="bg-white rounded-lg shadow">
          {loading ? <p className="p-4">Loading...</p> : backups.length === 0 ? <p className="p-4">No backups</p> : (
            <table className="min-w-full">
              <thead className="bg-gray-50 dark:bg-gray-900"><tr><th className="px-4 py-2 text-left">Type</th><th className="px-4 py-2 text-left">Size</th><th className="px-4 py-2 text-left">Status</th><th className="px-4 py-2 text-left">Created</th><th className="px-4 py-2 text-right">Action</th></tr></thead>
              <tbody>{backups.map(b => (
